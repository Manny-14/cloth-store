...
app.post("/admin/stripe/ensure-product-price", adminUpdateLimiter, requireAdminAuth, async (req, res) => {
  try {
    const {
      productId = "",
      productName,
    ...
    const normalizedCurrency = String(STRIPE_CURRENCY || "usd").toLowerCase();
