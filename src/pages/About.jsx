...
const About = () => {
  ...
  return (
    <div className="transition-colors duration-300">
      ...
      <div className={`text-lg text-center pt-8 border-t ${borderColor}`}>
        <Title text1="ABOUT" text2="US"/>
      </div>

      <div className="my-10 flex flex-col md:flex-row gap-16">
        <img src={assets.about_img} className="w-full md:max-w-[450px]" alt="about us image" />
        <div className={`flex flex-col justify-center gap-6 md:w-2/4 ${textColor}`}>
      ...
      <div className={`flex flex-col md:flex-row text-sm mb-20 ${textColor}`}>
        <div className={`border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5 ${borderColor}`}>
